...
export class Visualization extends Construct {
    ...
    constructor(scope: Construct, id: string, props: VisualizationProps) {
        ...
        const database = new Database(this, 'barometerdatabase', {
            databaseName: 'barometer',
        });

        const bucketmetrics = new Bucket(this, 'BucketMetricsCloudWatch');
        this.metricsbucket = bucketmetrics.bucketName;

        const costexplorertablename = 'costexplorer';
        const costexplorertable = new Table(this, 'costexplorertable', {
            database: database,
        ...
        new Table(this, 'cloudwatchmetricstable', {
            database: database,
        ...
        const cfnMetricStreamFirehose = new DeliveryStream(this, 'CloudWatchMetricsDeliveryStream', {
            destinations: [new S3Bucket(bucketmetrics, {
        ...
        const metricStreamRole = new Role(this, 'MetricStreamRole', {
            assumedBy: new ServicePrincipal('streams.metrics.amazonaws.com'),
        });
        ...
        const cfnMetricStream = new CfnMetricStream(this, 'MyCfnMetricStream', {
        ...
        const costExplorerIntegration = new Function(this, "costexplorerintegration", {
            code: Code.fromAsset(commonFunctionsDirPath + "costexplorer-integration"),
        ...
        const rule = new Rule(this, 'ScheduleRuleLambdaCostExplorer', {
            schedule: Schedule.cron({minute: '1', hour: '0'}),
            targets: [new LambdaFunction(costExplorerIntegration)]
        });

        const QuickSightGroupName = 'barometer'


        const cfnDataSource = new CfnDataSource(this, 'MyCfnDataSource', {
        ...
        const cfnDataSetCostExplorer = new CfnDataSet(this, 'DataSetCostExplorer', /* all optional props */ {
        ...
        const cfnDataSet = new CfnDataSet(this, 'DataSetMetrics', /* all optional props */ {
            awsAccountId: Aws.ACCOUNT_ID,
        ...
        const quicksightCreateDashboardCall: AwsSdkCall = {
            service: "QuickSight",
            ...
            physicalResourceId: PhysicalResourceId.of(`BarometerDashboard`), //
        };

        const quicksightCreateDashBoardResponce = new AwsCustomResource(
            this,
        ...
        const quicksightDeleteDashboardCall: AwsSdkCall = {
            service: "QuickSight",
        ...
        const quicksightDeleteDashBoardResponce = new AwsCustomResource(
            this,
